package com.cristianaugusto.projetospring.data;
...
public class BlogMockedData {
    ...
    public BlogMockedData() {
        ...
        blogs.add(new Blog(1L, "Go up, up and away with your Google Assistant",
        ...
        blogs.add(new Blog(2L, "Get local help with your Google Assistant",
        ...
        blogs.add(new Blog(3L, "The new maker toolkit: IoT, AI and Google Cloud Platform",
        ...
        blogs.add(new Blog(4L, "Learn more about the world around you with Google Lens and the Assistant",
        ...
        blogs.add(new Blog(5L, "7 ways the Assistant can help you get ready for Turkey Day",
